...
from src.common.event_manage import EvictEventSubscriber, event_manager
...
def cached(
    ...
    evict: EvictEventSubscriber = None,
) -> IdentityFunction:
    """
